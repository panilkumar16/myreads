...
https://github.com/panilkumar16/myreads.git
...
└── src
    ...
    ├── Book.js # Component to display Book with Title, Author, bookshelf selection
    ├── BooksAPI.js # A JavaScript API for the provided Udacity backend. Instructions for the methods are below.
    ├── index.css # Global styles.
    ├── index.js # It is used for DOM rendering.
    ├── ListShelves.js # Component to list the bookshelves
    ├── SearchBooks.js # Component to show search page to query books and select
